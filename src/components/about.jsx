        ...
        <div className="colorlib-narrow-content">
            ...
            <div className="col-md-4 text-center animate-box">
                ...
                <div className="desc">
                    ...
                    <p>I have experience working with Javascript, HTML, CSS, SCSS, React, NodeJS, Flask, Docker, Spring MVC ect.</p>
                </div>
                </div>
            </div>
            <div className="col-md-4 text-center animate-box">
                ...
                <div className="desc">
                    ...
                    <p>Since I'm a CSE graduate I have a good understanding on Data Structures and Algorithms</p>
                </div>
                </div>
            </div>
            <div className="col-md-4 text-center animate-box">
                ...
                <div className="desc">
                    ...
                    <p>I have studied classical Machine Learning, Deep Learning, Computer Vision and AI at my University</p>
                </div>
                </div>
            </div>
